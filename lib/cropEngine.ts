...
export function buildDynamicSmartCropFilter(
  ...
  const xExpr = buildFFmpegExprFromSegments(segments, maxX, frameCenterX, segmentDuration, nextSegmentFirstX, prevSegmentLastX, segmentEndsAtCut, segmentStartsAtCut)
